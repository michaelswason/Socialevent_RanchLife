package com.readinsite.ranchlife.ui.refresh;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                if (onCircleRefreshListener!=null && !mIsStarting) {
                    mIsStarting = true;
                        ...
                        if (mIsStarting ) {
                            Handler mHandler = new Handler() {
                                ...
                                public void handleMessage(Message msg) {
                                    ...
                                    onCircleRefreshListener.endRefresh();
                                }
                            };
                            mHandler.sendEmptyMessageDelayed(0, (long) (height * BACK_TOP_DUR / mHeaderHeight));
                            mIsStarting = false;
                        }
                    }
                }
